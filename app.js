...
function addMember() {
    ...
    .then(function({name, role, id, email}) {
        ...
        .then(function({roleInput, addMembers}) {
            let newEmployee;
            if (role === "Engineer") {
                newEmployee = new Engineer(name, id, email, roleInput);
            } else if (role === "Intern") {
                newEmployee = new Intern(name, id, email, roleInput);
            } else {
                newEmployee = new Manager(name, id, email, roleInput);
            }
...
function startHtml() {
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, startial-scale=1.0">
